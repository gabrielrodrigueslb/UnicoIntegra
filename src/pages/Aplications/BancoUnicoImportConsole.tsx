    ...
    <div className="overflow-hidden rounded-lg border border-gray-800 bg-gray-950">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-gray-800 bg-gray-900 px-5 py-3.5">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-sm font-semibold text-white">Console da importacao</h3>
            <p className="text-[11px] text-gray-400">
              Acompanhe o log real da subida desta importacao
            </p>
          </div>
          <span className="flex items-center gap-1.5 rounded-full border border-gray-700 bg-gray-950 px-2 py-0.5 text-[10px] font-medium text-gray-300">
            <span
      ...
      <div className="flex flex-wrap items-center gap-1 border-b border-gray-800 bg-black/20 px-5 py-2">
