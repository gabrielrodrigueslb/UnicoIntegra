...
type FormData =
  ...
  | { tipo: 'trier'; nome: string; token: string; trier_base_url: string; openai_api_key: string };
...
const INITIAL_TRIER_FORM: FormData = { tipo: 'trier', nome: '', token: '', trier_base_url: '', openai_api_key: '' };
      ...
      const payload = formData.tipo === 'alpha'
        ...
        : {
            ...
            env: {
              ...
              ...(formData.trier_base_url.trim()
                ? { TRIER_BASE_URL: formData.trier_base_url.trim() }
                : {}),
